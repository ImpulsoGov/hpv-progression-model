...
See [model description](model.md) for a detailed description of the model logic, transition diagram, and epidemiological parameters.

## Documentation

| Document | Contents |
|---|---|
| [Model description](model.md) | States, transitions, semi-Markov formulation, data sources |
| [Usage guide](usage.md) | Installation, running simulations, defining interventions, reading results |
| [API reference](reference/) | Full auto-generated reference for all public classes and functions |
