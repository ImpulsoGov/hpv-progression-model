...
def get_version(dist: str = "hpv_progression_model") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["hpv_progression_model"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("HPV_PROGRESSION_MODEL")]]
    return Environment(
